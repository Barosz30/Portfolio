...
const Projects = () => {
  ...
  const projects = [
    ...
    {
      title: t("projects.matchgame.title"),
      description: t("projects.matchgame.desc"),
      image:
        "https://images.unsplash.com/photo-1512428559087-560fa5ceab42?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D?w=800&h=600&fit=crop",
      tags: [
        "TypeScript",
        "Vue",
        "Nuxt",
      ...
      github: "https://github.com/Barosz30/Match-3",
      live: "https://match-3-lyart.vercel.app/",
    },
  ];
